...
- This module is the one that gets imported as backend and should expose methods 
  of the simulator submodule and all relevant types/methods that should be
  available in the backend namespace.
"""
